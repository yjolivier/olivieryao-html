<section class="bio-section col-12 page-section" id="bio-section">
    <div class="bio-section-content container">
        <div class="row">
            ...
            <div class="block-text col-lg-7 col-md-12 col-sm-12">
                ...
                tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, ehenderit in voluptate velit esse
                ...
                proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                <div class="btn">
                    <span class="cv-btn" text-data="Telecharger cv">
                        <a target="_blanc" href="#">Telecharger cv</a>
                    </span>
                    <span class="contact-btn" text-data="Contact">
                        <a href="#">Contacter</a>
                    </span>
                </div>
            </div>
